...
def main():
    ...
    if local_pdf.exists():
        ...
        logger.info(f"Loaded and cleaned {len(cleaned_hybrid)} pages using hybrid loader")
    ...
    if sites_file.exists():
        ...
        try:
            ...
            if web_documents:
                ...
                logger.info(f"Successfully scraped and cleaned {len(cleaned_web_docs)} web pages")
